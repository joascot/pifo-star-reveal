...
.finale-stat strong{display:block;font-family:var(--_typography---font-styles--heading,Poppins,sans-serif);font-size:clamp(66px,8vw,118px);font-weight:700;letter-spacing:-.03em;line-height:.95;color:#fff}
...
.finale-tagline{font-family:var(--_typography---font-styles--heading,Poppins,sans-serif);font-size:clamp(24px,2.8vw,42px);font-weight:600;letter-spacing:-.02em;line-height:1.1;margin:35px 0 0;color:#fff;will-change:transform,opacity}
